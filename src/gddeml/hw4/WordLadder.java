...
public class WordLadder {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Graph graph = new Graph(table.size() + 1);
		String min = avl.min();
		...
		BreadthFirstPaths breadthFirstPaths = new BreadthFirstPaths(graph, table.get(start));
		Iterable<Integer> path = breadthFirstPaths.pathTo(table.get(end));
		for (int i : path) {
